...
public partial class PlayerInteractView : ViewBase
{
    [SerializeField] InputActionAsset _actionAseet;
    [SerializeField] PlayerInteractModel _model;
    ...
    InputAction _menu;
    PlayerInteractPresenter _presenter;
    bool _subscribed;

    public override void Initialize()
    {
        _presenter = new PlayerInteractPresenter(this, _model);
